...
//			return "This is an example bot, replace this text with your schedule text? фывпкмвамьвдмь";
//		} else if(command.equalsIgnoreCase("!Привет")) {
//			return "И тебе привет, " + event.getUser().getNick();
//		}
//
//		return null;
//	}
		...
		if (message.equalsIgnoreCase("бот")) {
			...
			while(true) {
				...
				if (!bots.contains(nick)) {
					...
					Statistics.getStats().sendStat(nick, Statistics.TRAP);
					break;
				}
			}
		}
